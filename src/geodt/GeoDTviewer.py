...
if False:
    ...
    criteria = [['ResDepth', 6000.0, 10000.0], ['Qinj', 0.015, 0.050], ['w_spacing', 500.0, 800.0], ['w_count', 3, 5]]
...
hist2d(
    ...
    log=False,
    heat=True,
    x_label='reservoir temp (K)',
    y_label='electrical power output (kW)',
)
...
hist2d(
    ...
    log=False,
    heat=True,
    x_label='interval injection rate (m3/s)',
    y_label='electrical power output (kW)',
)
...
hist2d(
    ...
    log=False,
    heat=True,
    x_label='number of production wells',
    y_label='electrical power output (kW)',
)
...
hist2d(
    ...
    log=False,
    heat=True,
    x_label='number of injection intervals',
    y_label='electrical power output (kW)',
)
